...
ABOUT_THANKS_TITLE = (
    "O autor original agradece às pessoas abaixo pelas suas contribuições:"
)
...
ABOUT_DIALOG_STRINGS = {
    ...
    "diagnose any problems you encounter when you report an issue.": (
        "As informações de depuração abaixo ajudam a diagnosticar problemas. "
        "Inclua-as ao solicitar suporte."
    ),
}
...
# o texto exibido).
ABOUT_LICENSE = (
    "Este aplicativo é fornecido sem nenhuma garantia. Veja a "
...
class CartridgesApplication(Adw.Application):
    ...
    def do_activate(self) -> None:  # pylint: disable=arguments-differ
        ...
        # Com o botão Novidades oculto, ninguém vê as notícias: o feed nem é
        # consultado.
    ...
    def on_remove_game_action(self, *_args: Any) -> None:
        ...
        # desinstalado. O botão some na tela dele; isto cobre o menu do card.
        if shared.win.active_game.zerado:
            return
