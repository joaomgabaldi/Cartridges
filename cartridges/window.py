...
class CartridgesWindow(Adw.ApplicationWindow):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        # Oculto por padrão; a consulta ao feed acompanha a mesma chave, em
        # `CartridgesApplication.on_show_news_changed`.
        shared.schema.bind(
            "show-news-button",
            self.news_button,
            "visible",
    ...
    def retirar_da_grade(self, game: Game) -> None:
        """Tira o card de ``game`` da grade em que estiver e solta a capa.

        Como o DisplayManager faz: o FlowBoxChild sai da grade, mas continua
        segurando o jogo até soltá-lo. Usado pelo Excluir e pela ligação de um
        zerado ao jogo da biblioteca (`ligacao_zerado`).
        """
